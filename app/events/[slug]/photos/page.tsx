...
export async function generateMetadata({
  ...
  // Image is generated by app/events/[slug]/photos/opengraph-image.tsx
  // (1200×630 PNG via next/og's ImageResponse). Next.js auto-resolves
  // it via the file convention; no need to set `images` here. Doing so
  // would override the route file and we'd lose the proper sizing.
  return {
    title,
    description,
    robots: { index: false, follow: false },
