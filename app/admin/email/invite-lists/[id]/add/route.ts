...
/**
 * GET /admin/email/invite-lists/:id/add?ids=1,2,3&ids=4
...
export async function GET(
  ...
  if (!list) {
    return NextResponse.redirect(new URL("/admin/email/invite-lists", req.url));
  }
  ...
  return NextResponse.redirect(new URL(`/admin/email/invite-lists/${id}`, req.url));
}
